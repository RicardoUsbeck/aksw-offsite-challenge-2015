...
public class BestFoldStoringEvaluation {

    private static final Logger LOGGER = LoggerFactory.getLogger(BestFoldStoringEvaluation.class);
    ...
    public static void main(String[] args) throws IOException {
        BestFoldStoringEvaluation eval = new BestFoldStoringEvaluation();
    ...
    public double crossValidationError(int n, Approach approach) throws IOException {
        ...
        List<String> training, predicted, bestPredicted;
        for (int i = 0; i < n; i++) {
